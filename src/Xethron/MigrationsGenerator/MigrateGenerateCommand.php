...
class MigrateGenerateCommand extends GeneratorCommand {
    ...
    public function fire() {
        ...
        $this->schemaGenerator = new SchemaGenerator(
                $this->option('connection'), $this->option('defaultIndexNames'), $this->option('defaultFKNames')
        );
    ...
    protected function generateTablesAndIndices(array $tables) {
        ...
        foreach ($tables as $table) {
            ...
            if($foreignKeys = $this->schemaGenerator->getForeignKeyConstraints($this->table)){
                $new = [];
                foreach($foreignKeys as $foreignKey){
                    $foreignKey['foreignKey'] = true;
                    $new[] = $foreignKey;
                }
                $this->fields = array_merge($this->fields, $new);
            }
